...
class CalendarVM @Inject constructor(
    ...
    init {
        ...
        calendarBookingList.add(CalendarModel("Crish Evans ", "20 Dec 2021", "05:30 PM", "Los Angeles , CA"))
        calendarBookingList.add(CalendarModel("Daniel Redclief", "20 Dec 2021", "05:30 PM", "Los Angeles , CA"))
