...
public final class ProgressLoadingBinding implements ViewBinding {
  ...
  private ProgressLoadingBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressbar) {
  ...
  public static ProgressLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressLoadingBinding((LinearLayout) rootView, progressbar);
    }
