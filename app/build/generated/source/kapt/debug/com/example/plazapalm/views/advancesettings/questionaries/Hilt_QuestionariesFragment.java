 ...
 */
public abstract class Hilt_QuestionariesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuestionariesFragment() {
    super();
  }

  Hilt_QuestionariesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuestionariesFragment_GeneratedInjector) this.generatedComponent()).injectQuestionariesFragment(UnsafeCasts.<QuestionariesFragment>unsafeCast(this));
    }
  }
