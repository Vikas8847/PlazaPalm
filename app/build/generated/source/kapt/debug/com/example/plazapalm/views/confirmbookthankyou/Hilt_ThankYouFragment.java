 ...
 */
public abstract class Hilt_ThankYouFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ThankYouFragment() {
    super();
  }

  Hilt_ThankYouFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ThankYouFragment_GeneratedInjector) this.generatedComponent()).injectThankYouFragment(UnsafeCasts.<ThankYouFragment>unsafeCast(this));
    }
  }
