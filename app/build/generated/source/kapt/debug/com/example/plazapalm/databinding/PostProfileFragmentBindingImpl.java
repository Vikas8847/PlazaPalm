...
public class PostProfileFragmentBindingImpl extends PostProfileFragmentBinding implements com.example.plazapalm.generated.callback.AfterTextChanged.Listener {
    ...
    // variables
    @Nullable
    private final androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged mCallback12;
    // values
    // listeners
    ...
    private PostProfileFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback12 = new com.example.plazapalm.generated.callback.AfterTextChanged(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2000L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.etVEditProUserName, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, mCallback12, etVEditProUserNameandroidTextAttrChanged);
