 ...
 */
public abstract class Hilt_QRCodeGenerateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QRCodeGenerateFragment() {
    super();
  }

  Hilt_QRCodeGenerateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QRCodeGenerateFragment_GeneratedInjector) this.generatedComponent()).injectQRCodeGenerateFragment(UnsafeCasts.<QRCodeGenerateFragment>unsafeCast(this));
    }
  }
