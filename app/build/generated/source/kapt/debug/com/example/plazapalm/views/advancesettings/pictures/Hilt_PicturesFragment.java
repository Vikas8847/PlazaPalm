 ...
 */
public abstract class Hilt_PicturesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PicturesFragment() {
    super();
  }

  Hilt_PicturesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PicturesFragment_GeneratedInjector) this.generatedComponent()).injectPicturesFragment(UnsafeCasts.<PicturesFragment>unsafeCast(this));
    }
  }
