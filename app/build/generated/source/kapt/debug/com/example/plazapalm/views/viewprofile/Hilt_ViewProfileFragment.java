 ...
 */
public abstract class Hilt_ViewProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewProfileFragment() {
    super();
  }

  Hilt_ViewProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewProfileFragment_GeneratedInjector) this.generatedComponent()).injectViewProfileFragment(UnsafeCasts.<ViewProfileFragment>unsafeCast(this));
    }
  }
