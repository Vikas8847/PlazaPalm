 ...
 */
public abstract class Hilt_AdvanceMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvanceMapFragment() {
    super();
  }

  Hilt_AdvanceMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvanceMapFragment_GeneratedInjector) this.generatedComponent()).injectAdvanceMapFragment(UnsafeCasts.<AdvanceMapFragment>unsafeCast(this));
    }
  }
