 ...
 */
public abstract class Hilt_FontsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FontsListFragment() {
    super();
  }

  Hilt_FontsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FontsListFragment_GeneratedInjector) this.generatedComponent()).injectFontsListFragment(UnsafeCasts.<FontsListFragment>unsafeCast(this));
    }
  }
