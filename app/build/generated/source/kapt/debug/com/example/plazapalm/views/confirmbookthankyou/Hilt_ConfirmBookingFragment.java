 ...
 */
public abstract class Hilt_ConfirmBookingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ConfirmBookingFragment() {
    super();
  }

  Hilt_ConfirmBookingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ConfirmBookingFragment_GeneratedInjector) this.generatedComponent()).injectConfirmBookingFragment(UnsafeCasts.<ConfirmBookingFragment>unsafeCast(this));
    }
  }
