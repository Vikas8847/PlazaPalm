...
public class WelcomeFragmentBindingImpl extends WelcomeFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.gLineWelcomePlazza, 2);
        sViewsWithIds.put(R.id.ivWelcomePlaza, 3);
        sViewsWithIds.put(R.id.ivWelcomeLayers, 4);
        sViewsWithIds.put(R.id.tvWelcomeThankYou, 5);
        sViewsWithIds.put(R.id.tvWelcome, 6);
        sViewsWithIds.put(R.id.gLineNext, 7);
    }
    // views
    @NonNull
    ...
    private WelcomeFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.ivWelcomeNextBtn.setTag(null);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.example.plazapalm.views.welcome.WelcomeVM) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.example.plazapalm.views.welcome.WelcomeVM Vm) {
        this.mVm = Vm;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.plazapalm.views.welcome.WelcomeVM vm = mVm;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.ivWelcomeNextBtn.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.example.plazapalm.views.welcome.WelcomeVM value;
        public OnClickListenerImpl setValue(com.example.plazapalm.views.welcome.WelcomeVM value) {
            this.value = value;
