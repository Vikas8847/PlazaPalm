...
public class ViewprofileChooseoptionBindingImpl extends ViewprofileChooseoptionBinding  {
    ...
    public ViewprofileChooseoptionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ViewprofileChooseoptionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.tvDeleteProfile.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
            this.tvEditProfile.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
