...
public class LogoutAlertBindingImpl extends LogoutAlertBinding  {
    ...
    public LogoutAlertBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private LogoutAlertBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.tvLogoutCancel.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.tvLogOutBtn.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
            this.tvLogoutCancel.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
        }
    }
