 ...
 */
public abstract class Hilt_MyProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyProfileFragment() {
    super();
  }

  Hilt_MyProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyProfileFragment_GeneratedInjector) this.generatedComponent()).injectMyProfileFragment(UnsafeCasts.<MyProfileFragment>unsafeCast(this));
    }
  }
