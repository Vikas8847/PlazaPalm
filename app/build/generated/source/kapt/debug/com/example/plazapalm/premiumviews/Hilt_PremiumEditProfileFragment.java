 ...
 */
public abstract class Hilt_PremiumEditProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PremiumEditProfileFragment() {
    super();
  }

  Hilt_PremiumEditProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PremiumEditProfileFragment_GeneratedInjector) this.generatedComponent()).injectPremiumEditProfileFragment(UnsafeCasts.<PremiumEditProfileFragment>unsafeCast(this));
    }
  }
