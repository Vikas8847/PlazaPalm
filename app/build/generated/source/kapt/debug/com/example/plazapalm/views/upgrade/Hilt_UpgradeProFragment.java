 ...
 */
public abstract class Hilt_UpgradeProFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpgradeProFragment() {
    super();
  }

  Hilt_UpgradeProFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpgradeProFragment_GeneratedInjector) this.generatedComponent()).injectUpgradeProFragment(UnsafeCasts.<UpgradeProFragment>unsafeCast(this));
    }
  }
