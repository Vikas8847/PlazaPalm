 ...
 */
public abstract class Hilt_EmailVerifyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EmailVerifyFragment() {
    super();
  }

  Hilt_EmailVerifyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EmailVerifyFragment_GeneratedInjector) this.generatedComponent()).injectEmailVerifyFragment(UnsafeCasts.<EmailVerifyFragment>unsafeCast(this));
    }
  }
