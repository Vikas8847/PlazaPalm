 ...
 */
public abstract class Hilt_AddCitiesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddCitiesFragment() {
    super();
  }

  Hilt_AddCitiesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCitiesFragment_GeneratedInjector) this.generatedComponent()).injectAddCitiesFragment(UnsafeCasts.<AddCitiesFragment>unsafeCast(this));
    }
  }
