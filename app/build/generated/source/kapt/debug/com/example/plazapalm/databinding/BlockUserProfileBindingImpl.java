...
public class BlockUserProfileBindingImpl extends BlockUserProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvDeleteTitle, 2);
        sViewsWithIds.put(R.id.tvDeleteDescription, 3);
        sViewsWithIds.put(R.id.vDesc, 4);
        sViewsWithIds.put(R.id.vMid, 5);
        sViewsWithIds.put(R.id.tvBlockCancelBtn, 6);
    }
    // views
    @NonNull
    ...
    public BlockUserProfileBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private BlockUserProfileBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.tvBlockProfile.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.tvBlockProfile.setOnClickListener(vmOnClicksAndroidViewViewOnClickListener);
        }
    }
