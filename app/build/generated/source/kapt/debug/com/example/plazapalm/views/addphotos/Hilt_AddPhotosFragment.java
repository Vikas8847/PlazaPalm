 ...
 */
public abstract class Hilt_AddPhotosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddPhotosFragment() {
    super();
  }

  Hilt_AddPhotosFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddPhotosFragment_GeneratedInjector) this.generatedComponent()).injectAddPhotosFragment(UnsafeCasts.<AddPhotosFragment>unsafeCast(this));
    }
  }
