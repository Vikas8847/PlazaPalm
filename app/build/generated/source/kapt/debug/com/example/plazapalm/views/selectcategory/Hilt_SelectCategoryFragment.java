 ...
 */
public abstract class Hilt_SelectCategoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SelectCategoryFragment() {
    super();
  }

  Hilt_SelectCategoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectCategoryFragment_GeneratedInjector) this.generatedComponent()).injectSelectCategoryFragment(UnsafeCasts.<SelectCategoryFragment>unsafeCast(this));
    }
  }
