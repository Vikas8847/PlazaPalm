 ...
 */
public abstract class Hilt_VerifyEmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerifyEmailFragment() {
    super();
  }

  Hilt_VerifyEmailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerifyEmailFragment_GeneratedInjector) this.generatedComponent()).injectVerifyEmailFragment(UnsafeCasts.<VerifyEmailFragment>unsafeCast(this));
    }
  }
