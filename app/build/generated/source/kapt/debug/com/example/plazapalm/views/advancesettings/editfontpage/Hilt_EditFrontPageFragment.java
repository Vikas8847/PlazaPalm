 ...
 */
public abstract class Hilt_EditFrontPageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditFrontPageFragment() {
    super();
  }

  Hilt_EditFrontPageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditFrontPageFragment_GeneratedInjector) this.generatedComponent()).injectEditFrontPageFragment(UnsafeCasts.<EditFrontPageFragment>unsafeCast(this));
    }
  }
