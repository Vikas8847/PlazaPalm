 ...
 */
public abstract class Hilt_OpenCategeroyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OpenCategeroyFragment() {
    super();
  }

  Hilt_OpenCategeroyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OpenCategeroyFragment_GeneratedInjector) this.generatedComponent()).injectOpenCategeroyFragment(UnsafeCasts.<OpenCategeroyFragment>unsafeCast(this));
    }
  }
