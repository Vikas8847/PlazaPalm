 ...
 */
public abstract class Hilt_AdvanceSettingMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvanceSettingMapFragment() {
    super();
  }

  Hilt_AdvanceSettingMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvanceSettingMapFragment_GeneratedInjector) this.generatedComponent()).injectAdvanceSettingMapFragment(UnsafeCasts.<AdvanceSettingMapFragment>unsafeCast(this));
    }
  }
