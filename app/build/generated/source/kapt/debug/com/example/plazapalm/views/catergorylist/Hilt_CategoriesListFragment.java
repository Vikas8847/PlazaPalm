 ...
 */
public abstract class Hilt_CategoriesListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CategoriesListFragment() {
    super();
  }

  Hilt_CategoriesListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoriesListFragment_GeneratedInjector) this.generatedComponent()).injectCategoriesListFragment(UnsafeCasts.<CategoriesListFragment>unsafeCast(this));
    }
  }
