 ...
 */
public abstract class Hilt_TermsUseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TermsUseFragment() {
    super();
  }

  Hilt_TermsUseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TermsUseFragment_GeneratedInjector) this.generatedComponent()).injectTermsUseFragment(UnsafeCasts.<TermsUseFragment>unsafeCast(this));
    }
  }
