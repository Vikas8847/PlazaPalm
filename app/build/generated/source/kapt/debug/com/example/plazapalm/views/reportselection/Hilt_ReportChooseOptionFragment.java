 ...
 */
public abstract class Hilt_ReportChooseOptionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReportChooseOptionFragment() {
    super();
  }

  Hilt_ReportChooseOptionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReportChooseOptionFragment_GeneratedInjector) this.generatedComponent()).injectReportChooseOptionFragment(UnsafeCasts.<ReportChooseOptionFragment>unsafeCast(this));
    }
  }
