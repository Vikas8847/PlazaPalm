 ...
 */
public abstract class Hilt_AdvanceSettGalleryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvanceSettGalleryFragment() {
    super();
  }

  Hilt_AdvanceSettGalleryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvanceSettGalleryFragment_GeneratedInjector) this.generatedComponent()).injectAdvanceSettGalleryFragment(UnsafeCasts.<AdvanceSettGalleryFragment>unsafeCast(this));
    }
  }
