 ...
 */
public abstract class Hilt_PostProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PostProfileFragment() {
    super();
  }

  Hilt_PostProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostProfileFragment_GeneratedInjector) this.generatedComponent()).injectPostProfileFragment(UnsafeCasts.<PostProfileFragment>unsafeCast(this));
    }
  }
