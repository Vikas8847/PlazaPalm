 ...
 */
public abstract class Hilt_AdvanceSettingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvanceSettingFragment() {
    super();
  }

  Hilt_AdvanceSettingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvanceSettingFragment_GeneratedInjector) this.generatedComponent()).injectAdvanceSettingFragment(UnsafeCasts.<AdvanceSettingFragment>unsafeCast(this));
    }
  }
