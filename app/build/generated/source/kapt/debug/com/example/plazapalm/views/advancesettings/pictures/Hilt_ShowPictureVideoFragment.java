 ...
 */
public abstract class Hilt_ShowPictureVideoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ShowPictureVideoFragment() {
    super();
  }

  Hilt_ShowPictureVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShowPictureVideoFragment_GeneratedInjector) this.generatedComponent()).injectShowPictureVideoFragment(UnsafeCasts.<ShowPictureVideoFragment>unsafeCast(this));
    }
  }
