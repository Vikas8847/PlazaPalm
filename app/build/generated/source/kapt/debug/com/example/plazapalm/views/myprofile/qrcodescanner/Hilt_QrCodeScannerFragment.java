 ...
 */
public abstract class Hilt_QrCodeScannerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QrCodeScannerFragment() {
    super();
  }

  Hilt_QrCodeScannerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QrCodeScannerFragment_GeneratedInjector) this.generatedComponent()).injectQrCodeScannerFragment(UnsafeCasts.<QrCodeScannerFragment>unsafeCast(this));
    }
  }
