 ...
 */
public abstract class Hilt_FavDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FavDetailsFragment() {
    super();
  }

  Hilt_FavDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavDetailsFragment_GeneratedInjector) this.generatedComponent()).injectFavDetailsFragment(UnsafeCasts.<FavDetailsFragment>unsafeCast(this));
    }
  }
