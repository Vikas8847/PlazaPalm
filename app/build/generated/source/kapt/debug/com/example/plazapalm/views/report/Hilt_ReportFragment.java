 ...
 */
public abstract class Hilt_ReportFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReportFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReportFragment_GeneratedInjector) this.generatedComponent()).injectReportFragment(UnsafeCasts.<ReportFragment>unsafeCast(this));
    }
  }
