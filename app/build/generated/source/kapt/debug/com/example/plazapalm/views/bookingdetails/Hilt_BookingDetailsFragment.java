 ...
 */
public abstract class Hilt_BookingDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookingDetailsFragment() {
    super();
  }

  Hilt_BookingDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BookingDetailsFragment_GeneratedInjector) this.generatedComponent()).injectBookingDetailsFragment(UnsafeCasts.<BookingDetailsFragment>unsafeCast(this));
    }
  }
