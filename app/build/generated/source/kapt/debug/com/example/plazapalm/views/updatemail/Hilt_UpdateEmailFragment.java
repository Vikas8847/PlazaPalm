 ...
 */
public abstract class Hilt_UpdateEmailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateEmailFragment() {
    super();
  }

  Hilt_UpdateEmailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateEmailFragment_GeneratedInjector) this.generatedComponent()).injectUpdateEmailFragment(UnsafeCasts.<UpdateEmailFragment>unsafeCast(this));
    }
  }
