 ...
 */
public abstract class Hilt_AdvanceEditLookFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdvanceEditLookFragment() {
    super();
  }

  Hilt_AdvanceEditLookFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdvanceEditLookFragment_GeneratedInjector) this.generatedComponent()).injectAdvanceEditLookFragment(UnsafeCasts.<AdvanceEditLookFragment>unsafeCast(this));
    }
  }
