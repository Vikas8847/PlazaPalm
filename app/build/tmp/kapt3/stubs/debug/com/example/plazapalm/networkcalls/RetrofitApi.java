...
public abstract interface RetrofitApi {
    ...
    public abstract java.lang.Object mapFeatreData(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Authorization")
    java.lang.String Authorization, @retrofit2.http.Field(value = "darkTheme")
    boolean darkTheme, @retrofit2.http.Field(value = "locationOnOff")
    boolean locationOnOff, @retrofit2.http.Field(value = "follow")
    boolean follow, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.plazapalm.models.MapFeaturedDataRes>> continuation);
    
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.GET(value = "mapFeatureGet")
    public abstract java.lang.Object getMapFeatured(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Authorization")
    java.lang.String Authorization, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.plazapalm.models.GetMapFeature>> continuation);
    
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.POST(value = "updateLatLong")
    @retrofit2.http.FormUrlEncoded()
    public abstract java.lang.Object updateLatlng(@org.jetbrains.annotations.NotNull()
    @retrofit2.http.Header(value = "Authorization")
    java.lang.String Authorization, @retrofit2.http.Field(value = "user_lat")
    double user_lat, @retrofit2.http.Field(value = "user_long")
    double user_long, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.example.plazapalm.models.UpdateLatlngResponse>> continuation);
